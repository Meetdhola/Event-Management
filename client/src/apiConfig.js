...
export const API_BASE_URL = import.meta.env.DEV ? LOCAL_API_BASE : (import.meta.env.VITE_API_BASE_URL || RENDER_API_BASE);
export const SOCKET_URL = import.meta.env.DEV ? LOCAL_SOCKET_URL : (import.meta.env.VITE_API_URL || RENDER_SOCKET_URL);
