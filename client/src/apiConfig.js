...
export const API_BASE_URL = isLocal ? LOCAL_API_BASE : (import.meta.env.VITE_API_BASE_URL || RENDER_API_BASE);
export const SOCKET_URL = isLocal ? LOCAL_SOCKET_URL : (import.meta.env.VITE_API_URL || RENDER_SOCKET_URL);
